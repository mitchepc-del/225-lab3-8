pipeline {
    ...
    environment {
        ...
        DOCKER_CREDENTIALS_ID = 'mitchepc-dockerhub'        // Jenkins credential ID for authenticating with Docker Hub
        GITHUB_URL = 'https://github.com/mitchepc-del/225-lab3-8.git'  // GitHub repository containing Kubernetes YAML files
        KUBECONFIG = credentials('mitchepc-225')             // Jenkins stored credential for accessing your Kubernetes cluster
    }
